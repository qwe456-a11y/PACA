...
class TFDetect(keras.layers.Layer):
    ...
    def __init__(self, nc=80, anchors=(), ch=(), imgsz=(800, 800), w=None):  # detection layer
        super().__init__()
...
class TFModel:
    # TF YOLOv5 model
    def __init__(self, cfg='yolov5s.yaml', ch=3, nc=None, model=None, imgsz=(800, 800)):  # model, channels, classes
        super().__init__()
...
def run(
        ...
        imgsz=(800, 800),  # inference size h,w
